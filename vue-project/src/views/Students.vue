      ...
      <div class="tab-content active" id="newArival-tab">
        <div class="product-grid" id="all-products">
          <div class="product-card discount">
            <a href="product1.html" style="text-decoration: none; color: inherit">
              ...
              <div class="price-rating">
                <span class="price"> Rp8.099.000</span>
              </div>
            </a>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price"> Rp9.649.000​</span>
            </div>
          </div>
          <div class="product-card discount">
            <div class="image-slide-wrapper">
            ...
            <div class="price-rating">
              <span class="price"> Rp5.579.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price"> Rp16.999.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price">Rp6.749.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price">Rp8.399.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price"> Rp6.899.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price"> Rp5.399.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price">Rp18.199.000</span>
            </div>
          </div>
          ...
          <div class="product-card discount">
            ...
            <div class="price-rating">
              <span class="price"> Rp9.749.000</span>
            </div>
        </div>
        </div>
    </div>
